...
final Tween<Offset> _primaryTweenSlideFromBottomToTop = Tween<Offset>(
  begin: const Offset(0.0, 1.0),
  end: Offset.zero,
);

final Tween<Offset> _secondaryTweenSlideFromBottomToTop = Tween<Offset>(
  begin: Offset.zero,
  end: const Offset(0.0, -1.0),
);

/// 动画效果从顶部到底部的参数(primary)
final Tween<Offset> _primaryTweenSlideFromTopToBottom = Tween<Offset>(
  begin: const Offset(0.0, -1.0),
  end: Offset.zero,
);

final Tween<Offset> _secondaryTweenSlideFromTopToBottom = Tween<Offset>(
  begin: Offset.zero,
  end: const Offset(0.0, 1.0),
);

/// 动画效果从右边到左边的参数(primary)
final Tween<Offset> _primaryTweenSlideFromRightToLeft = Tween<Offset>(
  begin: const Offset(1.0, 0.0),
  end: Offset.zero,
);

/// 动画效果从右边到左边的参数(secondary)
final Tween<Offset> _secondaryTweenSlideFromRightToLeft = Tween<Offset>(
  begin: Offset.zero,
  end: const Offset(-1.0, 0.0),
);

/// 动画效果从左边到右边的参数(primary)
final Tween<Offset> _primaryTweenSlideFromLeftToRight = Tween<Offset>(
  begin: const Offset(-1.0, 0.0),
  end: Offset.zero,
);

/// 动画效果从左边到右边的参(secondary)
final Tween<Offset> _secondaryTweenSlideFromLeftToRight = Tween<Offset>(
  begin: Offset.zero,
  end: const Offset(1.0, 0.0),
);
...
class AnimationPageRoute<T> extends PageRoute<T> {
  ...
  Widget _buildFadeTransitionAnimateWidget(
    ...
    Widget childAnimWidget = FadeTransition(
  ...
  Widget _buildSlideTransitionAnimateWidget(
    ...
    Animation<Offset> childAnimation =
        CurvedAnimation(
          parent: pageAffectedType != PageAffectedType.Exit
              ? animation
              : secondaryAnimation,
  ...
  static SlideTransition _buildVerticalTransition(
    ...
    position:
        CurvedAnimation(
          ...
          animType == AnimationType.SlideBottomToTop
              ? (affectedType == PageAffectedType.Enter
