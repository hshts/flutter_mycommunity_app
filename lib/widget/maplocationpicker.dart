...
class _MapLocationPickerState extends State<MapLocationPicker>
  ...
  final AMapApiKey amapApiKeys = AMapApiKey(
    androidKey: 'a957b3baabd609fb68b51968fd066aa2',
    iosKey: '8108c7ed76ba703c5229f5569df0045b',
  );
  final AMapPrivacyStatement aMapPrivacyStatement = AMapPrivacyStatement(
    hasContains: true,
    hasShow: true,
    hasAgree: true,
  );
  ...
  Widget build(BuildContext context) {
    ...
    final Image image = Image.asset(_indicator, height: _iconSize);
    return Scaffold(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (!widget.isMapImage) Navigator.pop(context, map);
                        },
                      ),
                    ),
                  ),
  ...
  Future<void> _searchkeyword(String wordkeys, {bool ismore = false}) async {
    if (wordkeys.isNotEmpty) {
      ...
      _commonJSONService.getAmapWordKey(
        wordkeys,
        _searchtype,
        widget.citycode,
        true,
