    ...
    Widget report = Container(
      ...
      child: _isMySelf
          ...
          : IconText(
              ...
              direction: Axis.vertical,
              onTap: () {
                Navigator.pushNamed(context, '/ReportActivity', arguments: {
                  "actid": widget.actid,
                  ...
                  if (_isActivityInterests) {
                    ...
                    if (ret) {
                      _imHelper.saveNotInteresteduids(
                          Global.profile.user!.uid, widget.createuid!);
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: widget.sharedtype == "0" &&
                              ...
                              ? IconText("粉丝",
                                  ...
                                  direction: Axis.vertical, onTap: () {
                                  Navigator.pushNamed(
                                      context, '/ShardeFansList',
                                      arguments: {
                                        "content": widget.content,
                                        "contentid": widget.contentid,
                                        "sharedtype": widget.sharedtype,
                        ...
                        Container(
                          ...
                          child: widget.sharedtype == "0" &&
                                  widget.sharedtype != "2"
                              ? WXSessionShareWebPage(arguments: {
