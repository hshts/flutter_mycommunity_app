...
class PhotoViewSimpleScreen extends StatelessWidget {
  ...
  PhotoViewSimpleScreen({
    ...
    if (Global.profile.profilePicture != null) {
      imageProvider = AssetImage("images/icon_head_default.png");
    } else {
      imageProvider = Global.profile.defProfilePicture;
    }
  }
...
class PhotoViewImageHead extends StatelessWidget {
  ...
  PhotoViewImageHead({
    ...
    if (arguments["iscache"] != null && !arguments["iscache"]) {
      imageProvider = NetworkImage(arguments["image"].toString());
    } else {
      imageProvider = CachedNetworkImageProvider(arguments["image"].toString());
    }
  }
