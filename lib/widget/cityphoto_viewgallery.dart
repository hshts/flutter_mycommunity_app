...
class CityPhotoViewGallery extends StatefulWidget {
  ...
  CityPhotoViewGallery({super.key, required this.list});
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.list.length == 1) {
      double width = double.parse(
        widget.list[0]['imgwh'].toString().split(',')[0],
      );
      double height = double.parse(
        widget.list[0]['imgwh'].toString().split(',')[1],
      );
      if (height > width) {
        ...
        child: Hero(
          ...
          child: ClipRRect(
            ...
            child: CachedNetworkImage(
              fit: BoxFit.cover,
              imageUrl:
                  '${list[0]['img']}?x-oss-process=image/resize,m_fixed,w_600/sharpen,50/quality,q_80',
            ),
          ),
        ),
      );
              ...
              child: Hero(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    fit: BoxFit.fitWidth,
                    imageUrl:
                        '${list[index]['img']}?x-oss-process=image/resize,m_fill,w_600/sharpen,50/quality,q_80',
                  ),
                ),
              ),
            ),
