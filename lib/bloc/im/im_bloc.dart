...
class ImBloc extends Bloc<ImEvent, ImState> {
  ...
  Future<NewMessageState> getAllMessage(int uid) async {
    ...
    int commentreply_count = await imHelper
        .getCommentReplysCount(); //新的留言,评论与回复
    int follow_count = await imHelper.getNewFollowCount(); //新的关注
    int activityevalute_count = await imHelper
    ...
    SysMessage sysMessage = new SysMessage(
      commentreply_count,
      follow_count,
      activityevalute_count,
      neworderpending_count,
      neworderfinish_count,
      newlithumbup_count,
      unImReadCount + commentreply_count + follow_count + newlithumbup_count,
