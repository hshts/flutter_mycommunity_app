...
class UserNotice {
  ...
  UserNotice(
    this.uid,
    this.unread_comment,
    this.read_commentindex,
    this.unread_reply,
    this.read_replyindex,
    this.unread_sysnotice,
    this.read_sysnoticeindex,
    this.unread_member,
    this.read_member,
    this.unread_follow,
    this.read_follow,
    this.unevaluate_activity,
    this.evaluate_activity,
    this.unread_evaluate,
    this.read_evaluate,
    this.unread_evaluatereply,
    this.read_evaluatereply,
    this.unread_friend,
    this.read_friend,
    this.isUserUpdate,
    this.unread_shared,
    this.read_shared,
    this.unread_orderpending,
    this.unread_orderfinish,
    this.unread_actlike,
    this.read_actlike,
    this.unread_commentlike,
    this.read_commentlike,
    this.unread_evaluatelike,
    this.read_evaluatelike,
    this.unread_buglike,
    this.read_buglike,
    this.unread_suggestlike,
    this.read_suggestlike,
    this.unread_bugcomment,
    this.read_bugcomment,
    this.unread_suggestcomment,
    this.read_suggestcomment,
    this.unread_bugreply,
    this.read_bugreply,
    this.unread_suggestreply,
    this.read_suggestreply,
    this.unread_bugcommentlike,
    this.read_bugcommentlike,
    this.unread_suggestcommentlike,
    this.read_suggestcommentlike,
    this.unread_gpmsg,
    this.read_gpmsg,
    this.unread_communitymsg,
    this.read_communitymsg,
    this.unread_singlemsg,
    this.read_singlemsg,
    this.unread_goodpricecomment,
    this.read_goodpricecommentindex,
    this.unread_goodpricereply,
    this.read_goodpricereplyindex,
    this.unread_goodpricecommentlike,
    this.read_goodpricecommentlike,
    this.order_expiration,
    this.unread_momentlike,
    this.read_momentlike,
    this.unread_momentcomment,
    this.read_momentcomment,
    this.unread_momentreply,
    this.read_mementreply,
    this.unread_momentcommentlike,
    this.read_momentcommentlike,
  );
