...
User _$UserFromJson(Map<String, dynamic> json) => User(
  ...
  (json['likecomment'] as num?)?.toInt() ?? 0,
  (json['likeevaluate'] as num?)?.toInt(),
  (json['collectionproduct'] as num?)?.toInt(),
  json['aliuserid'] as String? ?? "",
  (json['likebug'] as num?)?.toInt() ?? 0,
  (json['likesuggest'] as num?)?.toInt() ?? 0,
  (json['likebugcomment'] as num?)?.toInt() ?? 0,
  (json['likesuggestcomment'] as num?)?.toInt() ?? 0,
  (json['likegoodpricecomment'] as num?)?.toInt() ?? 0,
  ...
  json['isNew'] as bool?,
  (json['business'] as num?)?.toInt() ?? 0,
  (json['likemoment'] as num?)?.toInt() ?? 0,
  (json['likemomentcomment'] as num?)?.toInt() ?? 0,
