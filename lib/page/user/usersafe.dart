              ...
              child: ListView(
                children: <Widget>[
                        ...
                        ListTile(
                          onTap: () async {
                            if (Global.profile.user!.aliuserid == "") {
                              String authurl = await _userService
                                  .getAliUserAuth();
                              //绑定支付宝账号
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  Global.profile.user!.aliuserid != ""
                                      ...
                                      : "未绑定",
                                  style: TextStyle(
                                    color: Global.profile.user!.aliuserid != ""
                                        ? Colors.black
                                        : Colors.black45,
                                    fontSize: contentfontsize,
                                  ),
                  ...
                  Card(
                    ...
                    child: ListTile(
                      onTap: () async {
                        await _userService.deltoken(
                          Global.profile.user!.token!,
                          Global.profile.user!.uid,
                          (String statusCode, String msg) {},
                        );
                        Global.profile.user = null;
                        Global.profile.defProfilePicture = AssetImage(
                          Global.headimg,
                        );
                        Global.saveProfile();
