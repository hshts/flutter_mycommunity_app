...
class MyAllReportList extends StatefulWidget {
  Object? arguments;
  bool isAppbar = false;
  MyAllReportList({super.key, arguments}) {
...
class _MyAllReportListState extends State<MyAllReportList> {
  ...
  int pagestatus = 0;
  Future<void> getMyReportList() async {
    myReports = await _activityService.getMyReport(
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pushNamed(
                context,
                '/MyReportInfo',
                arguments: {"reportid": e.reportid, "sourcetype": e.sourcetype},
              );
            },
          ),
        );
