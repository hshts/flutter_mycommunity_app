    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(
          context,
          '/ActivityInfo',
          arguments: {"actid": userShared.contentid},
        ).then((val) {});
      },
      child: Card(
        child: Column(
                ...
                ? Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl:
                            '${userShared.image}?x-oss-process=image/resize,m_fixed,w_600/sharpen,50/quality,q_80', //缩放压缩
                        fit: BoxFit.cover,
                      ),
                    ),
                  )
