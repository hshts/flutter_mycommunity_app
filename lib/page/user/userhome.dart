...
class MyHome extends StatefulWidget {
  ...
  MyHome({super.key, this.arguments}) {
    if (arguments != null) {
      isPop = true;
    }
  }
...
class _MyHomeState extends State<MyHome> {
  ...
  final int _newmemberCount = 0;
  final int _newFriendJoinCount = 0;
  ...
  Future<void> _hisBrowse() async {
    ...
    _collectioncount =
        (await _imHelper.selGoodPriceCollectionByUid(
          Global.profile.user!.uid,
        )).length +
        (await _imHelper.selActivityCollectionByUid(
          Global.profile.user!.uid,
        )).length;
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        IconText(
                          '问题建议',
                          icon: Icon(IconFont.icon_jianyi, size: 29),
                        ...
                        IconText(
                          '账户安全',
                          icon: Icon(IconFont.icon_zhanghuanquan1, size: 29),
                          style: TextStyle(fontSize: 12, color: Colors.black),
                          direction: Axis.vertical,
                          padding: EdgeInsets.only(bottom: 5),
                          onTap: () {
                        ...
                        IconText(
                          '帮助中心',
                          icon: Icon(IconFont.icon_bangzhu_kefu, size: 29),
                          style: TextStyle(fontSize: 12, color: Colors.black),
                          direction: Axis.vertical,
                          padding: EdgeInsets.only(bottom: 5),
                          onTap: () {
                        ...
                        IconText(
                          '关于玩吧',
                          icon: Icon(IconFont.icon_guanyuwomen2, size: 29),
                          style: TextStyle(fontSize: 12, color: Colors.black),
                          direction: Axis.vertical,
                          padding: EdgeInsets.only(bottom: 5),
                          onTap: () {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        IconText(
                          '加入我们',
                          icon: Icon(IconFont.icon_jiaruwomen1, size: 29),
                          style: TextStyle(fontSize: 12, color: Colors.black),
                          direction: Axis.vertical,
                          padding: EdgeInsets.only(bottom: 5),
                          onTap: () {
                  ...
                  Column(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.pushNamed(context, '/MyProfile').then((
                            value,
                          ) {
                            setState(() {});
                          });
  ...
  Widget buildSysManage() {
    return Container(
      ...
      child: ListTile(
        ...
        leading: Icon(Icons.build, size: 23, color: Colors.blue),
        title: Text(
          '运维通道',
