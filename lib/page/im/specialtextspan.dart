  ...
  SpecialText? createSpecialText(
    ...
    if (isStart(flag, EmojiText.flag)) {
      ...
      return LocationText(
        textStyle,
        null,
        start: index - (LocationText.flag.length - 1),
        isText: isText,
        pageWidth: pagewidth,
      );
      ...
      return SharedText(
        textStyle,
        myonTap,
        start: index - (SharedText.flag.length - 1),
        isText: isText,
        pageWidth: pagewidth,
      );
...
class EmojiText extends SpecialText {
  ...
  InlineSpan finishText() {
    ...
    if (EmojiUitl.instance.emojiMap.containsKey(key) && !kIsWeb) {
      ...
      return ImageSpan(
        AssetImage(EmojiUitl.instance.emojiMap[key] ?? "images/emoji/8.png"),
        actualText: key,
        imageWidth: size,
        imageHeight: size,
        start: start,
...
class SoundText extends SpecialText {
  ...
  InlineSpan finishText() {
    ...
    return ExtendedWidgetSpan(child: webContent);
  }
}
            ...
            Expanded(
              child: isText
                  ...
                  : ClipRRectOhterHeadImageContainerByWidthNoEventNoHeight(
                      ...
                      sourceWidth: double.parse(imginfo[1].split(',')[0]),
                      sourceHeight: double.parse(imginfo[1].split(',')[1]),
                    ),
            ),
          ],
        ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ClipRRectOhterHeadImageContainerLocationNoEvent(
                              imageUrl: locatoninfo[0],
                              width: pageWidth + 29,
                              height: 160,
                              lat: lat,
                              lng: lng,
                              title: locatoninfo[3].split(":")[1],
                              address: locatoninfo[2].split(":")[1],
                            ),
                          ],
                        ),
                      ),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Image(
                            image: isopen
                                ? AssetImage("images/redpacket_open.png")
                                : AssetImage("images/redpacket_close.png"),
                            fit: BoxFit.cover,
                            width: 39,
                            height: 39,
                          ),
                    ...
                    Container(
                      ...
                      color: Colors.white,
                      child: Text(
                        redpackettype == "0" ? "拼手气红包$status" : "普通红包$status",
