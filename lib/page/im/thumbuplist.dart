...
class _ThumbUpListState extends State<ThumbUpList> {
  ...
  void initState() {
    ...
    _replyNoticeBloc.add(
      readed(Global.profile.user!, replyMsgType: ReplyMsgType.newliked),
    ); //全部点赞都已读
  }
                ...
                onTap: () async {
                  if (item.liketype == 0) {
                    Navigator.pushNamed(
                      context,
                      '/ActivityInfo',
                      arguments: {"actid": item.contentid},
                    );
                  }
                  ...
                  if (item.liketype == 3) {
                    Navigator.pushNamed(
                      context,
                      '/BugInfo',
                      arguments: {"bugid": item.contentid},
                    );
                  }
                  ...
                  if (item.liketype == 4) {
                    Navigator.pushNamed(
                      context,
                      '/SuggestInfo',
                      arguments: {"suggestid": item.contentid},
                    );
                  }
                  ...
                  if (item.liketype == 8 || item.liketype == 9) {
                    Navigator.pushNamed(
                      context,
                      '/MomentInfo',
                      arguments: {"momentid": item.contentid},
                    );
                  }
                },
              ),
