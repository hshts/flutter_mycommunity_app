...
class SharedRelationList extends StatefulWidget {
  ...
  SharedRelationList({super.key, this.arguments}) {
    if (arguments != null) {
            ...
            return Column(
              ...
              children: <Widget>[
                GestureDetector(
                  ...
                  onTap: () {
                    _imBloc.add(
                      Already(Global.profile.user!, item.timeline_id),
                    );
                    Navigator.pushReplacementNamed(
                      ...
                      arguments: {
                        "GroupRelation": item,
                        "sharedcontent":
                            "|shared: ${widget.sharedtype}#${widget.contentid}#${widget.content}#${widget.image}|",
                        "localsharedcontent":
                            "|shared: ${widget.sharedtype}#${widget.contentid}#${widget.content}#${widget.localimg}|",
                      },
                    ).then((val) {
                      _imBloc.add(getlocalRelation(Global.profile.user!));
                    });
