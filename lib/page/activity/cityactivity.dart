...
class CityActivity extends StatefulWidget {
  ...
  const CityActivity({super.key, this.parentJumpShop});
    ...
    return Scaffold(
      floatingActionButton: _isTop
          ? FloatingActionButton(
              ...
              child: Icon(IconFont.icon_rocket, color: Colors.black45),
            )
          : SizedBox.shrink(),
          ...
          child: BlocBuilder<CityActivityDataBloc, CityActivityState>(
            ...
            builder: (context, state) {
              ...
              if (state is PostSuccess) {
                ...
                if (state.activitys != null && state.activitys!.isNotEmpty) {
                  for (var element in state.activitys!) {
                    lists.add(
                      Padding(
