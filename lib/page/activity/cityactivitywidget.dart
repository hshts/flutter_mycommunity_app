                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3),
                            Text(
                              '${widget.activity.joinnum! + 1}人想参加',
                              style: TextStyle(
                      ...
                      children: [
                        InkWell(
                          child: ShareView(
                            ...
                            image: widget.activity.coverimg,
                            contentid: widget.activity.actid,
                            content: widget.activity.content,
                            sharedtype: "0",
                            actid: widget.activity.actid,
                            createuid: widget.activity.user!.uid,
                          ),
                          onTap: () {},
                        ),
                        Row(
