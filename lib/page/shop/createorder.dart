  ...
  Widget build(BuildContext context) {
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Wrap(spacing: 13, children: values),
            ],
          ),
        ),
      );
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          buildHeadInfo(),
          Expanded(child: ListView(children: specsContent)),
        ...
        children: [
          Container(
            ...
            child: ClipRRectOhterHeadImageContainer(
              imageUrl: widget.goodPiceModel.pic,
              cir: 10,
            ),
          ),
          Expanded(
