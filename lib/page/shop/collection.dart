...
class MyCollectionGoodPrice extends StatefulWidget {
  const MyCollectionGoodPrice({super.key});
...
class _MyCollectionGoodPriceState extends State<MyCollectionGoodPrice> {
  ...
  Future<void> getMyCollection() async {
    _goodPriceModels = await _imHelper.selGoodPriceCollectionByUid(
    ...
    return Scaffold(
      ...
      body: _isPageLoad
          ? ((_goodPriceModels.isEmpty)
                ...
                : ListView(children: buildProductContent(_goodPriceModels)))
          : Center(
    ...
    return RefreshIndicator(
      ...
      child: Column(
        children: [
          Expanded(
            child: Container(
              child: ListView(children: buildProductContent(_goodPriceModels)),
            ),
          ),
        ],
      ),
