...
class GPService {
  ...
  Future<List<SearchResult>> hotsearchProduct() async {
    ...
    await NetUtil.getInstance().get(
      "/grouppurchase/hotsearchProduct",
  ...
  //收藏好价优惠
  Future<bool> updateGoodPriceCollection(
  ...
  Future<List<Comment>> getCommentList(
    ...
    await NetUtil.getInstance().get(
      ...
      params: {"goodpriceid": goodpriceid.toString(), "uid": uid.toString()},
  ...
  //搜索商品
  Future<List<GoodPiceModel>> searchProduct(
    String ordertype,
    String citycode,
    int currentIndex,
    bool isAllCity,
  ...
  Future<GoodPiceModel?> getGoodPriceInfo(String goodpriceid) async {
    GoodPiceModel? goodPiceModel;
    await NetUtil.getInstance().get(
      "/grouppurchase/getGoodPriceInfo",
      (Map<String, dynamic> data) {
        goodPiceModel = GoodPiceModel.fromJson(data["data"]);
      },
      params: {"goodpriceid": goodpriceid.toString()},
      errorCallBack: errorResponse,
    );
  ...
  //参加活动
  Future<Activity?> joinGPActivity(
    String actid,
    int uid,
    String token,
    String username,
  ...
  Future<List<Activity>> getActivityList(String goodpriceid) async {
    ...
    await NetUtil.getInstance().get(
      ...
      params: {"goodpriceid": goodpriceid},
      errorCallBack: errorResponse,
    );
    return activitys;
  }
  ...
  //通知服务器客户端支付成功
  Future<bool> updategoodpricestatus(
    int uid,
    String token,
    String goodpriceid,
    int status,
  ...
  Future<List<GoodPiceModel>> getGoodPriceList() async {
    List<GoodPiceModel> goodPrices = [];
    await NetUtil.getInstance().get(
      "/grouppurchase/getSysGoodPriceCheck",
      (Map<String, dynamic> data) {
        if (data["data"] != null) {
          for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<List<GoodPiceModel>> getMyGoodPricePendingList() async {
    List<GoodPiceModel> goodPrices = [];
    await NetUtil.getInstance().get(
      "/grouppurchase/getMyGoodPricePendingList",
      (Map<String, dynamic> data) {
        if (data["data"] != null) {
          for (int i = 0; i < data["data"].length; i++) {
            goodPrices.add(GoodPiceModel.fromJson(data["data"][i]));
  ...
  Future<List<GoodPiceModel>> getMyGoodPriceFinishList() async {
    List<GoodPiceModel> goodPrices = [];
    await NetUtil.getInstance().get(
      "/grouppurchase/getMyGoodPriceFinishList",
      (Map<String, dynamic> data) {
        if (data["data"] != null) {
          for (int i = 0; i < data["data"].length; i++) {
            goodPrices.add(GoodPiceModel.fromJson(data["data"][i]));
  ...
  Future<List<GoodPiceModel>> getRecommendGoodPriceList(
    ...
    await NetUtil.getInstance().get(
      ...
      params: {
        "type": type.toString(),
        "currentIndex": currentIndex.toString(),
        "citycode": Global.profile.locationGoodPriceCode,
      },
      errorCallBack: errorResponse,
    );
  ...
  //获取评价列表
  Future<List<EvaluateActivity>> getEvaluateGoodPriceList(
    String goodpriceid,
    int currentIndex,
    Function errorCallBack,
  ) async {
