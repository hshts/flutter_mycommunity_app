...
class CommonJSONService {
  ...
  Future<void> getActivityTypesByName(Function call, String typename) async {
    FormData formData = FormData.fromMap({"typename": typename});
    await NetUtil.getInstance().post(
      formData,
      "/Activity/getActivityTypeListByTypeName",
      call,
      errorResponse,
    );
  }
  ...
  Future<void> getAppProfileConfig(Function call) async {
    await NetUtil.getInstance().get(
      "/SysConfig/getConfigParameter",
      call,
      params: {"parameterkey": "userimgconfig"},
      errorCallBack: errorResponse,
    );
  }
  ...
  Future<void> getPurchaseChannelsConfig(Function call) async {
    await NetUtil.getInstance().get(
      "/SysConfig/getConfigParameter",
      call,
      params: {"parameterkey": "purchasechannels"},
      errorCallBack: errorResponse,
    );
  }
  ...
  Future<void> getMessagReportsConfig(Function call) async {
    await NetUtil.getInstance().get(
      "/SysConfig/getConfigParameter",
      call,
      params: {"parameterkey": "messagreport"},
      errorCallBack: errorResponse,
    );
  }
  ...
  Future<void> getSysVersionAndContentConfig(Function call) async {
    await NetUtil.getInstance().get(
      "/SysConfig/getConfigParameter",
      call,
      params: {"parameterkey": "appversionupdate"},
      errorCallBack: errorResponse,
    );
  }
  ...
  Future<void> getPhoneCode(Function call) async {
    await NetUtil.getInstance().get(
      "/SysConfig/getFileContent",
      call,
      params: {"parameterkey": "phonecode"},
      errorCallBack: errorResponse,
    );
  }
  ...
  Future<void> getAmapPoi(
    ...
    await NetUtil.getInstance(baseUrl: "https://restapi.amap.com").wget(
      "/v5/place/around",
      call,
      params: {
        "key": "39825835e128f68a89a8635dbcb9c2d2",
        "location": location,
        "types": types,
